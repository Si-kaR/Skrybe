...
//     try {
//       // Use Hive to store the onboarding completion status
//       final settingsBox = Hive.box('settings');
//       await settingsBox.put('onboardingCompleted', true);
//       debugPrint('✅ Onboarding marked as completed in Hive');
//     } catch (e) {
...
//     context.go('/welcome');
//     // You can also use context.goNamed('welcome') if you prefer using named routes
//   }
...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  Future<void> _markOnboardingComplete() async {
    // Try to use Hive first
    try {
      // Check if Hive box exists and is open
      if (Hive.isBoxOpen('settings')) {
        ...
        try {
          ...
          await settingsBox.put('onboardingCompleted', true);
          debugPrint('✅ Hive box opened and onboarding marked as completed');
          return;
        } catch (e) {
    ...
    try {
      ...
      debugPrint('✅ Onboarding marked as completed in SharedPreferences');
    } catch (e) {
      debugPrint('❌ Error saving onboarding status to SharedPreferences: $e');
    }
  }
  ...
  void _navigateToWelcome() {
    _markOnboardingComplete().then((_) {
      try {
        context.go('/welcome');
        debugPrint('✅ Navigated to welcome screen');
      } catch (e) {
        debugPrint('❌ Error navigating to welcome screen: $e');
        // Fallback navigation
        try {
          Navigator.of(context).pushReplacementNamed('/welcome');
          debugPrint('✅ Used fallback navigation to welcome screen');
        } catch (e) {
...
//     context.go('welcome');
//     // or context.pushReplacement() depending on your GoRouter setup
//   }
